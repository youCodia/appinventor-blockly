...
Blockly.utils.object.inherits(Blockly.FieldLexicalVariable, Blockly.FieldDropdown);
...
Blockly.FieldLexicalVariable.getGlobalNames = function (optExcludedBlock) {
  if (Blockly.getMainWorkspace() && Blockly.getMainWorkspace().getWarningHandler && Blockly.getMainWorkspace().getWarningHandler().cacheGlobalNames) {
