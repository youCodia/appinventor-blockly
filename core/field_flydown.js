...
Blockly.utils.object.inherits(Blockly.FieldFlydown, Blockly.FieldTextInput);
...
Blockly.FieldFlydown.prototype.showFlydown_ = function() {
  ...
  var blocksXMLList = blocksDom.childNodes; // List of blocks for flydown
...
Blockly.FieldFlydown.prototype.onHtmlInputChange_ = function(e) {
  ...
  if (text !== htmlInput.oldValue_) {
    ...
    this.setValue(text);
    var valid = htmlInput.value !== text;
    if (valid) {
